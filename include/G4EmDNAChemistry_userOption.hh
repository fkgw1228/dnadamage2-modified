...
// ********************************************************************
//
/// \file G4EmDNAChemistry_userOption.hh
/// \brief Definition of the Chemistry parameters with DNA reactions
/*
 * G4EmDNAChemistryUserOption.hh
 *
...
class G4EmDNAChemistryUserOption : public G4VUserChemistryList,
                                   public G4VPhysicsConstructor
{
public:
    G4EmDNAChemistryUserOption();
    G4EmDNAChemistryUserOption(G4double, G4double);
